...
if our code is hard to read, you can use `beautify file` VS Code plugin, to do that press `Shift + Ctrl + P` it will show search form. type beautify and choose it. it will change our code to be readable 
...
* go to `pages` section. Pick `source` to `master branch`, then click save
![](./assets/github-pages.png)
* you will see the url given from `github pages` section. try to click them
![](./assets/github-pages-success.png)
* don't forget to add on description. follow below picture
![](./assets/github-code-edit.png)
* after that, put the url given then save it
* it will show you on description, so people can look on your web directly by clicking it
![](./assets/github-code-description.png)
